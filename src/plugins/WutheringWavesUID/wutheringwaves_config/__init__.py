...
from ..gsuid_core_compat import Bot
from ..gsuid_core_compat import Event
from ..gsuid_core_compat import SV
from ..config_system import core_config
...
PREFIX = core_config.get_plugin_available_prefix("WutheringWavesUID")


# TODO 暂时不需要 @sv_self_config.on_prefix("设置")
